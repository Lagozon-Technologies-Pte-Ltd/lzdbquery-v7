...
Query_Record_Size_Boolean = secret_variables.get("Query_Record_Size_Boolean")
Query_record_size = secret_variables.get("Query_Record_Size")
...
async def lifespan(app: FastAPI):
    ...
    credentials_info = {
        "type": secret_variables.get("GOOGLE_CREDENTIALS_TYPE"),
        "project_id": secret_variables.get("GOOGLE_CREDENTIALS_PROJECT_ID"),
        "private_key_id": secret_variables.get("GOOGLE_CREDENTIALS_PRIVATE_KEY_ID"),
        ...
        "client_email": secret_variables.get("GOOGLE_CREDENTIALS_CLIENT_EMAIL"),
        "client_id": secret_variables.get("GOOGLE_CREDENTIALS_CLIENT_ID"),
